...
const layout = ref([
  {id: "Meters", x: 0, y: 0, w: 2, h: 4, i: "Meters", template: "simpleWidget", color: "green", title: "Meters", indicators: { mainIndicator: { title: "1.3M", description: "1320000"}, secondIndicator: {title: "+17", description: "Last 24 Hours"}}, chart: {type: "bar", data: barChartDataMeters}},
  {id: "Dcus", x: 2, y: 0, w: 2, h: 4, i: "Dcus", template: "simpleWidget", color: "purple", title: "Dcus", indicators: { mainIndicator: { title: "200", description: ""}, secondIndicator: {title: "+17", description: "Last 24 Hours"}}, chart: {type: "bar", data: barChartDataDcus} },
  {id: "Connected", x: 4, y: 0, w: 2, h: 4, i: "Connected", template: "simpleWidget", color: "blue", title: "Connected meters", indicators: { mainIndicator: { title: "77%", description: ""}, secondIndicator: {title: "+24%", description: "Last 24 Hours"}}, chart: {type: "bar", data: barChartDataCM} },
  {id: "Map", x: 6, y: 0, w: 2, h: 4, i: "Map", template: "previewWidget", color: "gray", previewUrl: "images/map.png" , title: "", indicators: false, chart: false },
